            ...
            <section className="py-16 px-6 ">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 ">
                    <div className="text-center p-6">
                        ...
                        <p className="text-gray-400">Доставка по всему миру в кратчайшие сроки</p>
                    </div>
                    <div className="text-center p-6">
                        <div className="text-4xl mb-4">💯</div>
                        <h3 className="text-xl font-semibold mb-2">Гарантия качества</h3>
                        <p className="text-gray-400">100% оригинальные товары с гарантией</p>
                    </div>
                    <div className="text-center p-6">
                        <div className="text-4xl mb-4">💳</div>
                        <h3 className="text-xl font-semibold mb-2">Безопасная оплата</h3>
                        <p className="text-gray-400">Защищенные платежи и конфиденциальность</p>
                    </div>
                </div>
            </section>
