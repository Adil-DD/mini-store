      ...
      <div className="lg:flex lg:items-start lg:gap-8">
        ...
        <div className="lg:flex-1">
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            {/* Главное изображение */}
            <div
              className="order-1 lg:order-2 flex-1 flex items-center justify-center bg-white rounded relative overflow-hidden cursor-pointer"
              onClick={toggleZoom}
        ...
        <aside className="mt-6 lg:mt-0 lg:w-[340px]">
          <div className="lg:sticky lg:top-24 bg-white border rounded p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm text-gray-500">Быстрая покупка</div>
                <div className="text-2xl font-bold text-gray-900 mt-1">{product.title}</div>
              </div>
            </div>

            <div className="mt-4">
              <div className="text-3xl font-extrabold text-indigo-600">${product.price}</div>
              <div className="text-sm text-gray-500 mt-1">(Цена указана в USD)</div>
            </div>

            <div className="mt-6">
              <label className="text-sm text-gray-600 mb-2 block">Количество</label>
